    ...
    <div>
      <div className="flex  flex-col mt-4   ">
        {items.map((item, index) => {
          return (
            <div className="flex  justify-between bg-white mt-4  p-4 ">
              ...
              <div className="flex gap-4 items-center">
                ...
                <div className="p-5 h-6 w-6 rounded-md bg-[#09D690]">
                  <BiDollar className="text-white text-2xl -ml-3 -mt-3" />
                  {/* <FaSackDollar /> */}
              ...
              <div className=" flex items-center">
                <button className="p-2 pl-5 pr-5 rounded-sm bg-[#2668E81F] text-[#2668E8] cursor-pointer ">
                  Apply Now
                </button>
              </div>
            </div>
